...
## Detalle de actualizaciones instaladas (auditoría)
...
así que el plugin no intenta listar actualizaciones "faltantes" KB por KB — la antigüedad del
último parche detectado es la señal práctica de si un equipo está quedando atrás.
...
└── front/
    ...
    ├── updates.php            # Endpoint AJAX: detalle de KBs instalados por equipo
